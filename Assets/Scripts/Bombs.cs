...
public class Bombs : MonoBehaviour
{
    ...
    public GameObject second_player; // игрок
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.X)) // создание бомб
        {
            BombsList.Add(Instantiate(bombs[0], second_player.transform.position, Quaternion.identity)); //  инициализация бомб и добавление их в список
            StartCoroutine(ExplosionBomb(BombsList[BombsList.Count - 1])); // запуск куронтина
